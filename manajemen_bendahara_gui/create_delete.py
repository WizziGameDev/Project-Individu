...
def creDel():
    ...
    # Tombol Cancel
    buttonCancel = Button(frameButton, text='Cancel', font=('roboto', 8), foreground='white', background='green', activebackground='white',
                          activeforeground='black', borderwidth=1, command=desTroy)
    buttonCancel.grid(row=1, column=0, ipadx=10, ipady=2)

    # Tombol Delete Data
    buttonDelete = Button(frameButton, text='Delete', font=('roboto', 8), foreground='white', background='green', activebackground='white',
                          activeforeground='black', borderwidth=1, command=functionDelete)
    ...
    buttonCreate = Button(frameButton, text='Create', font=('roboto', 8), foreground='white', background='green', activebackground='white',
                          activeforeground='black', borderwidth=1, command=functionCreate)
