...
def funcUserPage():
    ...
    # Function Log Out
    def funcLogOut():
        user_root.destroy() # Menghancurkan page user
        from login_page import funcLoginPage # Beralih ke page login
        funcLoginPage()
    ...
    # Button Update
    buttonUpdate = Button(FrameButton, text='UPDATE', font=('roboto', 9), foreground='white', background='green', activebackground='white',
                        activeforeground='black', borderwidth=0, cursor='hand2', command=funcUpdate)
    buttonUpdate.grid(row=0, column=0, ipadx=30, ipady=3, pady=20, padx=10)

    # Button Log Out
    buttonLogOut = Button(FrameButton, text='LOG OUT', font=('roboto', 9), foreground='white', background='red', activebackground='white',
                        activeforeground='black', borderwidth=0, cursor='hand2', command=funcLogOut)
    buttonLogOut.grid(row=0, column=1, ipadx=27, ipady=3, pady=20, padx=10)
